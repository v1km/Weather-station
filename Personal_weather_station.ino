...
String network = "Martian";                            // your access point SSID
String password = "bhulgaya123";                  // your wifi Access Point password
#define IP "184.106.153.149"                        // IP address of thingspeak.com
String GET = "13E5OAZZIDDTF1H9";    // replace with your channel key
